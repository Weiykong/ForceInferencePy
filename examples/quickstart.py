...
if not os.path.exists(IMG_PATH):
    raise FileNotFoundError(
        f"Bundled image not found at {IMG_PATH}.\n"
...
# 2. Segment
# ------------------------------------------------------------------
print("Step 1 / 4 — Segmenting image …")
labels, img_processed = segment_grayscale(IMG_PATH, h_depth=5, blur_sigma=1, min_cell_size=20)
